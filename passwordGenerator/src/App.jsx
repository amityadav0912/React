...
function App() {
  ...
  const passwordGenerator = useCallback(()=>{
    ...
    if(numbersIncluded) string+="0123456789";
    if(specialCharIncluded) string+="!@#$%^&*-_+=[]{}~`";
    ...
    setPassword(pass);
}, [length, numbersIncluded, specialCharIncluded]);
  ...
  useEffect(()=>{
    passwordGenerator();
  }, [length, numbersIncluded, specialCharIncluded, passwordGenerator]);
  ...
  return (
      <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 bg-gray-800 text-orange-500">
        ...
        <div className="flex shadow rounded-lg overflow-hidden mb-4">
          ...
          className="outline-none bg-blue-700 text-white px-3 py-0.5 shrink-0 active:bg-green-500 transition-all">
            Copy
          </button>
        </div>
